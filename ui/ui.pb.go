...
package ui // import "github.com/evilsocket/opensnitch/ui"

import proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import network "github.com/evilsocket/opensnitch/network"
import rules "github.com/evilsocket/opensnitch/rules"
...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ui_56189876b56860a0, []int{0}
}
...
func (*PingReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_ui_56189876b56860a0, []int{1}
}
...
func (*Statistics) Descriptor() ([]byte, []int) {
	return fileDescriptor_ui_56189876b56860a0, []int{2}
}
...
func (*Event) Descriptor() ([]byte, []int) {
	return fileDescriptor_ui_56189876b56860a0, []int{3}
}
...
func init() { proto.RegisterFile("opensnitch/ui/ui.proto", fileDescriptor_ui_56189876b56860a0) }

var fileDescriptor_ui_56189876b56860a0 = []byte{
	// 686 bytes of a gzipped FileDescriptorProto
	,
}

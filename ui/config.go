...
const (
	...
	DefaultConfigAction   = rules.Action_ALLOW
	DefaultConfigDuration = rules.Duration_ONCE
)
...
type config struct {
	...
	Action   rules.Action   `json:"default_action"`
	Duration rules.Duration `json:"default_duration"`
}

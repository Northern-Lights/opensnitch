...
func (Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rules_5eb1c05d2a8ea096, []int{0}
}
...
const (
	...
	Duration_PROCESS_SESSION  Duration = 4
...
func (Duration) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rules_5eb1c05d2a8ea096, []int{1}
}
...
func (Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rules_5eb1c05d2a8ea096, []int{2}
}
...
func init() { proto.RegisterFile("opensnitch/rules/rules.proto", fileDescriptor_rules_5eb1c05d2a8ea096) }

var fileDescriptor_rules_5eb1c05d2a8ea096 = []byte{
	// 478 bytes of a gzipped FileDescriptorProto
	,
}
